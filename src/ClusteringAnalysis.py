...
def dataset1_test():
    train_X, train_y = read_dataset1('data/cancer2.tra')
    test_X, test_y = read_dataset1('data/cancer2.tes')

    test1(train_X, train_y, 2, 10, 'dataset1')
    #(X, y, min_n, max_n, dataset):
    ...
    test3(train_X, train_y, 2, 1, n_features, 'dataset1')
    #(X, y, n_labels, interval, n_features, dataset):
    test4and5(train_X, train_y, test_X, test_y, 2, n_features, 1)

    #train_X, train_y, test_X, test_y, start, n_features, interval):
    plot_projection_graph(train_X, 2, 'dataset1', 'dataset1_graph.png')



def dataset2_test():
    X, y = read_dataset2('data/data3.csv')
    ...
    test3(X, y, 4, 1, n_features, 'dataset2')

    plot_projection_graph(X, 2, 'dataset2', 'dataset2_graph.png')
